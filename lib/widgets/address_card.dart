...
class AddressCard extends StatelessWidget {
  ...
  AddressCard({this.data, required this.onTapSelect});
  ...
  Widget _buildingInfo(BuildContext context) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.start,
      children: [
        Container(
